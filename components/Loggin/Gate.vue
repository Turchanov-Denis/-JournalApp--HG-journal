    ...
    <div
      ...
      >
        ...
        <div class="log-field">
          ...
          <div>
            <button  @click="()=>{this.$store.dispatch('login/switchGateMail')}"  class="log-field__button">
          ...
          <div class="log-field__entire" >
            Нет аккаунта? <div style="" @click="()=>{this.$store.dispatch('login/switchRegMail')}">Регистрация</div>
          </div>
        </div>
      </div>
</template>
